...
class Installer
{
    public static $packageInfo = [
        ...
        '3.1.12' => [
            'tree'     => 'Evolution',
            'name'     => 'Evolution CMS Community Edition 3.1.12',
        ...
        '1.4.23' => [
            'tree'     => 'Evolution',
            'name'     => 'Evolution CMS Community Edition 1.4.23',
            'link'     => 'https://github.com/evocms-community/evolution/archive/refs/tags/1.4.23.zip',
            'location' => 'install/index.php'
        ],
        '1.4.x'  => [
            'tree'     => 'Evolution',
            'name'     => 'Evolution CMS Community Edition (1.4.x develop version)',
    ...
    public static function hasProblem()
    {
        if(!extension_loaded('curl')) {
            return '<h2 class="warning">Cannot download the files - CURL is not enabled on this server.</h2>';
        }
...
<head>
    ...
    <style>
        ...
        article, aside, audio, b, body, canvas, dd, details, div, dl, dt, em, fieldset, figcaption, figure, footer, form, h1, h2, h3, h4, h5, h6, header, hgroup, html, i, img, label, li, mark, menu, nav, ol, p, section, span, strong, summary, table, tbody, td, tfoot, th, thead, time, tr, u, ul, video {
            margin: 0;
            padding: 0;
            border: 0;
            outline: 0;
        ...
        html {
            position: relative;
            background: #f8f8f8 url(https://installer.evolution-cms.com/img/base.png)
        }
        ...
        .button, button {
            ...
            background-image: linear-gradient(to top, #67a749 0, #67a749 27.76%, #a1c755 100%);
            text-shadow: 0 0 2px rgba(0, 0, 0, .64)
        }
